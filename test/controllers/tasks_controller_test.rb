...
class TasksControllerTest < ActionDispatch::IntegrationTest
  test "POST /api/v1/tasks creates a task" do
    ...
    assert_equal "Learn Rails", json["title"]
    assert_equal "Build a CRUD API", json["description"]
  ...
  test "PATCH /api/v1/tasks/:id updates a task" do
    ...
    json = JSON.parse(response.body)
    assert_equal "Learn Ruby on Rails", json["title"]
    assert_equal "API connected to PostgreSQL.", json["description"]
    assert_equal false, json["completed"]
  end
